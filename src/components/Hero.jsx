  ...
  return (
    ...
    >
        <div className="container relative">
          ...
          <div className="mt-12">
            <div className="-translate-y-3 z-2 absolute top-[6rem] mt-6 uppercase font-extrabold text-[3rem] sm:text-[3rem] sm:mt-[4.8rem] sm:leading-[3.5rem] leading-[2.8rem] md:text-[4rem] md:leading-[4.5rem] md:mt-[5.3rem] lg:text-[5rem] lg:mt-[9.8rem] lg:leading-[5.5rem] xl:text-[6rem] xl:mt-[16.5rem] xl:leading-[6.5rem] 2xl:text-[7rem] 2xl:leading-[7.8rem] 2xl:mt-[15rem]">
